package top.aftery.mybatis.generator.mapper;
...
public interface CoffeeMapper {
     ...
     *
     * @mbg.generated Tue Mar 31 17:55:43 CST 2020
     */
    ...
    @Insert({
        ...
        "values (#{name,jdbcType=VARCHAR}, #{price,jdbcType=BIGINT,typeHandler=top.aftery.mybatis.generator.handler.MoneyTypeHandler}, ",
    ...
    @ResultMap("top.aftery.mybatis.generator.mapper.CoffeeMapper.BaseResultMap")
    ...
    @Update({
        ...
        "set name = #{name,jdbcType=VARCHAR},",
          "price = #{price,jdbcType=BIGINT,typeHandler=top.aftery.mybatis.generator.handler.MoneyTypeHandler},",
