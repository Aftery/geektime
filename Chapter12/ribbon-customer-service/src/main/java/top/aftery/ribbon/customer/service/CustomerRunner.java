package top.aftery.ribbon.customer.service;
...
import top.aftery.ribbon.customer.service.model.Coffee;
import top.aftery.ribbon.customer.service.model.CoffeeOrder;
import top.aftery.ribbon.customer.service.model.NewOrderRequest;
...
public class CustomerRunner implements ApplicationRunner {
    ...
    private void readMenu() {
        ...
        ResponseEntity<List<Coffee>> list = restTemplate
                .exchange("http://eureka-waiter-service/coffee/", HttpMethod.GET, null, ptr);
    ...
    private Long orderCoffee() {
        ...
        RequestEntity<NewOrderRequest> request = RequestEntity
                .post(UriComponentsBuilder.fromUriString("http://eureka-waiter-service/order/").build().toUri())
                .body(orderRequest);
    ...
    private void queryOrder(Long id) {
        CoffeeOrder order = restTemplate
                .getForObject("http://eureka-waiter-service/order/{id}", CoffeeOrder.class, id);
