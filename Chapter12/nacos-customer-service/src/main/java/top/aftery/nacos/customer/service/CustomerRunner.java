package top.aftery.nacos.customer.service;
...
import top.aftery.nacos.customer.service.model.Coffee;
import top.aftery.nacos.customer.service.model.CoffeeOrder;
import top.aftery.nacos.customer.service.model.NewOrderRequest;
...
public class CustomerRunner implements ApplicationRunner {
    ...
    private void showServiceInstances() {
        ...
        discoveryClient.getInstances("cnacos-waiter-service").forEach(s -> {
    ...
    private Long orderCoffee() {
        ...
        RequestEntity<NewOrderRequest> request = RequestEntity
                .post(UriComponentsBuilder.fromUriString("http://nacos-waiter-service/order/").build().toUri())
                .body(orderRequest);
    ...
    private void queryOrder(Long id) {
        CoffeeOrder order = restTemplate
                .getForObject("http://nacos-waiter-service/order/{id}", CoffeeOrder.class, id);
